...
/** Modale bloquante sur la page de connexion (première connexion back-office). */
export function AdminFirstLoginPasswordModal({
  open,
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" role="presentation">
      ...
      <aside
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="admin-first-login-title"
      >
        <div className="flex flex-1 flex-col justify-center px-6 py-8 sm:px-8">
          <h2 id="admin-first-login-title" className="text-xl font-bold tracking-tight text-zinc-900">
            Nouveau mot de passe
          </h2>
          <p className="mt-1 text-sm text-zinc-500">Back-office — Azure</p>
          <div className="mt-7">
